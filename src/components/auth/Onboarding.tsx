  ...
  const onboardingSlides = [
    {
      ...
      icon: <img src="/pwa/icons/onboard/onboard-1.png" alt="بررسی بلیت" className="w-24 h-24" />,
    ...
    },
    {
      ...
      icon: <img src="/pwa/icons/onboard/onboard-2.png" alt="سیستم چک این" className="w-24 h-24" />,
    ...
    },
    {
      ...
      icon: <img src="/pwa/icons/onboard/onboard-3.png" alt="تاییدیه" className="w-24 h-24" />,
