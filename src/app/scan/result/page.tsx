      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md p-8 text-center">
          ...
          <h2 className={`text-2xl font-bold mb-2 ${
            ...
            {status === 'SUCCESS' ? 'Valid Ticket' : 'Invalid Ticket'}
          </h2>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
              ...
              {seat && (
                <div className="mb-2">
                  ...
                  <span className="ml-2 text-gray-800">{seat}</span>
                </div>
              )}
              {time && (
                <div className="mb-2">
                  <span className="font-medium text-gray-600">Check-in Time:</span>
                  <span className="ml-2 text-gray-800">{new Date(time).toLocaleString()}</span>
                </div>
              )}
            </div>
          )}
          ...
          <div className="mb-6">
            <p className="text-gray-600">Scanning next ticket in {countdown} seconds...</p>
          </div>
